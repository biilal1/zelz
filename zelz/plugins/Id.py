...
zed_dev = (7291869416, 7291869416, 7291869416, 7291869416, 7291869416, 7291869416, 9291869416)
zel_dev = (9291869416, 7291869416, 7291869416, 7291869416)
zelzal = (7291869416, 7291869416, 9291869416)
...
################# Dev ZilZal #################
    if user_id in zelzal: 
        ...
        rotbat = "العضـو 𓅫"
################# Dev ZilZal #################
    ZED_TEXT = gvarstatus("CUSTOM_ALIVE_TEXT") or "•⎚• مـعلومـات المسـتخـدم مـن بـوت ماتركـس"  
    ZEDM = gvarstatus("CUSTOM_ALIVE_EMOJI") or "✦ " 
    ZEDF = gvarstatus("CUSTOM_ALIVE_FONT") or "⋆─┄─┄─┄─ ᵐᵃᵗʳᶤˣ ─┄─┄─┄─⋆" 
